...
*Adapted from the master script to enable predictions from Phi-4 Mini.

Logic is identical to the master script, with one exception: model
responses are no longer required to be strictly JSON. Specifying a
response_format causes Phi-4 Mini to hang.*
"""
